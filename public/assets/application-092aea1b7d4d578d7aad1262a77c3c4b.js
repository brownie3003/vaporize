...
(function() {
  $(function() {
    var allFlavoursPicked, autoPickFlavours, resetFlavoursPicker, showFlavourPicker, showSubscription, signupComplete, user;
    user = {
      subscription: {
        price: void 0,
        bottles: void 0,
    ...
    showSubscription = function() {
      ...
      if (user.cigarette === true) {
        ...
        $(".one-month").find(".pricing-explanation").html("You will simply pay £" + user.subscription.price + " per month for your e-liquid.");
      }
